...
internal class TextTest
{
    ...
    {
        SetText("012345");
        var result = _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 0), new(0, 4)));
    ...
    {
        SetText("012345");
        _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 1), new(0, 6)));
    ...
    {
        SetText("012345");
        _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 1), new(0, 5)));
    ...
    {
        SetText("012345");
        _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 0), new(0, 6)));
        Assert.AreEqual("", _text.ToString());
    }
    ...
    {
        SetText("012345\n012345");
        var result = _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 0), new(1, 4)));
        Assert.AreEqual("45", _text.ToString());
    ...
    {
        SetText("012345\n012345");
        var result = _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 2), new(1, 4)));
    ...
    {
        SetText("012345\n012345");
        var result = _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 2), new(1, 6)));
    ...
    {
        SetText("012345\n555555");
        var result = _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 0), new(0, 6)));
    ...
    {
        SetText("012345\n555555");
        var result = _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(1, 0), new(1, 6)));
    ...
    {
        SetText("012345\n012345");
        var result = _text.DeleteSelection(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 0), new(1, 6)));
        Assert.AreEqual("", _text.ToString());
        Assert.AreEqual(1, result.FirstDeletedLineIndex);
        Assert.AreEqual(1, result.DeletedLinesCount);
    }
    ...
    {
        SetText("abc\nxyz");
        _text.SetSelectedTextCase(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 0), new(1, 1)), TextCase.Upper);
        Assert.AreEqual("ABC\r\nXyz", _text.ToString());

        SetText("ABC\nXYZ");
        _text.SetSelectedTextCase(new TextSelectionLineConverter(_text).GetSelectedLines(new(0, 0), new(1, 1)), TextCase.Lower);
        Assert.AreEqual("abc\r\nxYZ", _text.ToString());
    }
