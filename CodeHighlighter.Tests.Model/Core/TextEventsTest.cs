...
internal class TextEventsTest
{
    ...
    {
        _text = new Text();
        _events = new TextEvents(_text, new TextChangedEventArgsFactory(new EditTextResultToLinesChangeConverter(new TextLinesChangingLogic())));
    ...
    {
        _text.TextContent = "123\n123";
        _text.DeleteSelection(new TextSelectionLine[] { new(0, 0, 0), new(1, 0, 3) });
        _events.RaiseTextChanged();
        Assert.AreEqual(1, _linesCount);
    }
